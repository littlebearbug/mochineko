...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 left-0 right-0 z-50 ">
      <nav className="flex items-center justify-between px-4 md:px-6 lg:px-8 py-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700">
        <Link
          href="/"
